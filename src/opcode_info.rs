...
#[repr(u8)]
pub enum OpMnemonic {
    ADC = 0, AHX, ANC, AND, ALR, ARR, ASL, AXS, BCC, BCS, BEQ, BIT, BMI, BNE, BPL, BRK, BVC, BVS, CLC, CLD, CLI, CLV,
    CMP, CPX, CPY, DCP, DEC, DEX, DEY, EOR, INC, INX, INY, ISC, JMP, JSR, KIL, LAS, LAX, LDA, LDX, LDY,
    LSR, NOP, ORA, PHA, PHP, PLA, PLP, RLA, ROL, ROR, RRA, RTI, RTS, SAX, SBC, SEC, SED, SEI, SHY,
    SHX, SLO, SRE, STA, STX, STY, TAS, TAX, TAY, TSX, TXA, TXS, TYA, XAA
}
...
pub const OPCODE_INSTRUCTIONS: [OpcodeInfo; 256] = [
	...
	OpcodeInfo::new(OpMnemonic::ASL, ZPG, 3, 0, 2),
	...
	OpcodeInfo::new(OpMnemonic::AND, IMT, 4, 0, 2),
	OpcodeInfo::new(OpMnemonic::ROL, ACC, 6, 0, 1),
	OpcodeInfo::new(OpMnemonic::ANC, IMT, 2, 0, 2),
	...
	OpcodeInfo::new(OpMnemonic::SHY, ABS_X, 5, 0, 3),
